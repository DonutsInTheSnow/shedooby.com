  ...
  return (
    <div className="bg-[#d7cdbc]"> 
      ...
      <section className="pb-32 max-w-[1050px] md:max-w-[500px] lg:max-w-[1050px] mx-auto"> 
        <div className="bg-[#cac0b0] h-[42px] mx-4"></div>
        <p className="text-[14px] text-center text-black font-semibold py-4">Mission Brief: Lashes</p>
        <div className="grid grid-cols-6 gap-4 lg:gap-12 text-black p-4 font-inter">
          <div className="col-span-6 lg:col-span-3 text-[19px] font-semibold">
            <p className="pb-3">Shedooby was built to reclaim lost ground. No do-overs. The past is a closed door. The only question that matters now, how do you maximize the present?</p>
            <p className="pb-3">Wherever you stand in life—if you&apos;re still breathing, you&apos;re still in the fight. That background noise between your ears? Mind chatter. Reallocate that wasted wattage. Focus it on your mission set. You&apos;ll be surprised what you&apos;re capable of building when you lock onto your AO (Area of Operations).</p>
            <p className="pb-3">There was a Star Trek episode in which Captain Kirk, Mr. Spock, et al, faced the Earp brothers in a simulation at the OK Corral? The landing party survived not through brute force but belief—mental training. The Vulcan Mind Lock wasn&apos;t sci-fi fluff. It was tactical focus. That is <em>Shedooby</em>. Train your mind to distinguish the real from the distraction. Techno static? Turn that shit off. Focus on targets that matter.</p>
            <p className="pb-3">The image of John Lennon at 40 is an embarrassment to masculinity. Once the apex alpha who excited millions of fertile young women, he was reduced to something soft and infantilized. What the hell happened? What made him surrender? Let this be a warning: Don&apos;t become ornamental. If you&apos;re able-bodied and idle, you&apos;re not living—you&apos;re freeloading. Fix it.</p>
            <p className="p-3 bg-gray-100 text-[#a1211f] font-mono">Hey Lennon. An able bodied, able minded man should earn a living. Get off your wife&apos;s teat. <span className="text-black text-medium">(Reclaim your masculinity.)</span></p>
            <div className="py-7">
