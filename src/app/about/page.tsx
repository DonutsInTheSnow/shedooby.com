       ...
       <section className="pt-[120px] pb-32 max-w-[1050px] md:max-w-[500px] lg:max-w-[1050px] mx-auto"> 
        ...
        <div className="grid grid-cols-2 gap-4 lg:gap-7 text-black p-4 font-inter text-[19px] font-semibold">
            <div className="col-start-1 col-end-3 lg:col-end-2">
                ...
                <p>This app was born out of necessity. The time for excuses is over. No more squandering hours arguing with strangers. No more soaking in dopamine traps built to addict. No more chilling out.</p>
            </div>
            <div className="col-start-1 col-end-3 lg:col-start-2">
                <p className="pb-3">Shedooby is your digital drill sergeant. Every day, several times a day, it calls you to attention. It reminds you of your mission. Stay off social media. Stay sober. Show up with purpose. The weaker ones will lay down quick, the stronger will emerge transformed.</p>
