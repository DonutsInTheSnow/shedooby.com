      ...
      <section className="pb-32 max-w-[1050px] md:max-w-[500px] lg:max-w-[1050px] mx-auto"> 
        ...
        <div className="grid grid-cols-6 gap-4 lg:gap-12 text-black p-4 font-inter">
          <div className="col-span-6 lg:col-span-3 text-[19px] font-semibold">
            ...
            <p className="p-3 bg-gray-100 text-[#a1211f] font-mono">Hey Lennon. An able bodied man should earn a living. Get off your wife&apos;s teat. <span className="text-black text-medium">(Be a man, not a man-child.)</span></p>
            <div className="py-7">
